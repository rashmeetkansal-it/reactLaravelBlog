    ...
    <div>
        <section className="topbar">
            <div className="container">
                <div className="row">
                    <p><i className="fa fa-phone"></i> xx xxxxxxxxx || Email : <i className="fa fa-envelope"></i>
                        email@email.com</p>
                </div>
            </div>
        </section>
                ...
                <div className="row">
                    ...
                    <div className="header-info">
                        ...
                        <div className="hf-item">
                            ...
                            <p><span>Location : </span> Chandigarh</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    <div id='cssmenu'>
                        <ul>
                            ...
                            <li><Link className='navbar-brand' to='/myaccount'>My Account</Link></li>
